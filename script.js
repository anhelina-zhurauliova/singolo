window.onload = function () {
  ...
  const verticalPhone = document.querySelector('.vertical_image');
  ...
  const horizontalPhone = document.querySelector('.horizontal_image');
  ...
  for (let n of tabs) {
    n.addEventListener('click', (event) => {
      ...
      array.forEach(n => document.querySelector(".portfolio__images").append(n));
  ...
  form.addEventListener('submit', (event) => {
    ...
    if (form.checkValidity()) {
      subjectRes.textContent = (subjectInput.value) ? subjectInput.value : "No subject"
      descriptionRes.textContent = (description.value) ? description.value : "No description "
